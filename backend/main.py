...
from usage import check_usage_limit, log_chat, get_admin_headers  # 👉 Added get_admin_headers
...
async def chat(tenant_id: str, request: Request, background_tasks: BackgroundTasks):
    ...
    # 👉 NEW: Extract the custom ID generated by the widget
    message_id = data.get("message_id")
    visitor_id = data.get("visitor_id") # 👉 NEW: Extract visitor ID 
    ...
    async def stream_generator():
        ...
        # 👉 NEW: Pass the message_id to the logger
        background_tasks.add_task(log_chat, tenant_id, user_query, full_ai_response, message_id)
        # 👉 UPDATE: Pass visitor_id to the logger at the bottom!
...
async def get_chat_history(tenant_id: str, visitor_id: str):
    ...
    async with httpx.AsyncClient() as client:
        ...
        # Filter by both the tenant AND the specific visitor, sorted oldest to newest
